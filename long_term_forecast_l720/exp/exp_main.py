...
from models import Informer, Autoformer, Transformer, DLinear, Linear, NLinear, PatchTST,Xformer
    ...
    def vali(self, vali_data, vali_loader, criterion,is_test = True):
        ...
        with torch.no_grad():
            for i, (batch_x, batch_y, batch_x_mark, batch_y_mark) in enumerate(vali_loader):
                ...
                if self.args.model == 'Xformer' and not is_test:
